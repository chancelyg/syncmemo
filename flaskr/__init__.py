...
from flaskr.dependents import config, CONST_VERSION, Memo
...
def get_memo(memo_id: str):
    ...
    return render_template("template_memo.html", memo_id=memo_id, localStoreLength=10, img=qrcode_base64, memo_content=memo.get(memo_id.upper()), hex_str=hex_str)
